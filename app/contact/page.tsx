        ...
        <div className="container mx-auto px-6 lg:px-12 relative z-10">
          <AnimatedSection className="max-w-3xl">
            ...
            <p className="mt-6 text-lg text-black leading-relaxed">
              Ready to start your next engineering project? We'd love to hear from you. Reach out and let's discuss how <strong>VrtexGlobal</strong> can help bring your vision to life.
            </p>
          </AnimatedSection>
        </div>
      </section>
