...
const slides = [
  ...
  {
    image: "/images/engdes.jpeg",
    tagline: "Engineering Design",
    description:
      "Complex Engineering design considerations including tooling feasibility.",
  },
];
...
const services = [
  ...
  },
  {
    ...
    description: "Enclosure design with aesthetic, ergonomic and environmental friendly.",
  },
  {
    icon: Settings,
            ...
            {services.map((service, index) => (
              ...
              >
                <Link href={`/services#${service.slug}`}>
                  <div className="group bg-background p-8 border border-border hover:border-foreground transition-all duration-300 h-full cursor-pointer">
